...
while(True):
    try:
      ...
      for face in faces:
        ...
        str = "Blink Your Eyes"
        cv2.rectangle(img, pt1=tuple(eye_rect_l[0:2]), pt2=tuple(eye_rect_l[2:4]), color=(51,255,153), thickness=2)
        cv2.rectangle(img, pt1=tuple(eye_rect_r[0:2]), pt2=tuple(eye_rect_r[2:4]), color=(51,255,153), thickness=2)
